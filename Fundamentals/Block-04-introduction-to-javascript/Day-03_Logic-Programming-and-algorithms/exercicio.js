...
console.log(idades);
if (menorIdade === Marcella){
    console.log("Marcella é a mais nova com ", menorIdade);
}
else if (menorIdade === Carlos) {
    console.log("Carlos é o mais novo com ", menorIdade);
}
else if (menorIdade === Camila) {
    console.log("Camila é a mais nova com ", menorIdade);
}
